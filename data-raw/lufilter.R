...
lufilter <- tibble::tribble(~filter, ~desc,
                    ...
                    "time (temporal bin)", "within a specified date range",
                    "cell (spatial bin)", "as a byproduct of converting sites to cells",
                    "rel", "spatial reliability",
                    "ann", "non-persistent taxa",
                    "taxa", "taxonomy",
                    "single", "singletons",
                    "geo", "as a byproduct of assigning all contexts to a geographic area",
