...
taxonomy_overrides <- tibble::tribble(
  ...
  "Pentaschistis thunbergii", "Pentameris pallida", "Pentameris pallida", NA, "Pentaschistis thunbergii/Pentameris pallida", # Pentaschistis thunbergii should now be Pentameris pallida according to Flora of SA, but both currently accepted by ALA.
  "Rubus Scott-Creek", "Rubus sp. Scott Creek", "Rubus Scott-Creek", NA, "Undescribed Native blackberry from Scott Creek in MLR", # galah::search_taxa returns an introduced marine gastropod for 'Rubus Scott-Creek' despite this being the species name in ALA.
  "Poterium sanguisorba", "Sanguisorba minor", "Sanguisorba minor", NA, "Salad/Sheep's Burnet",  # Accepted in FloraSA as: Sanguisorba minor subsp. muricata Briq. ALA has both at species level, i.e. duplicated.
  "Eucalyptus diversifolia ssp. Diversifolia", "Eucalyptus diversifolia ssp. diversifolia", "Eucalyptus diversifolia", "Eucalyptus diversifolia subsp. diversifolia", "Eucalyptus diversifolia ssp mismatch", # ALA somehow matches incorrectly to Eucalyptus platydisca (a WA species), as a result of the capital 'D' for the first letter of the subspecies. Arising from traits data.
  "Anthus australis", "Anthus novaeseelandiae", "Anthus novaeseelandiae", NA, "Australian Pipit", # Anthus australis (old name, originating from BSA distributions) incorrectly matched to new nominate subspecies
  "Cacatua roseicapilla", "Eolophus roseicapilla", "Eolophus roseicapilla", NA, "Galah", # Cacatua roseicapilla (old name) incorrectly matched to new nominate subspecies. NB. does not deal with data coming from ALA, as we're taking the already converted ALA scientific/species name.
  "Calyptorhynchus funereus", "Zanda funerea", "Zanda funerea", NA, "Yellow-tailed Black Cockatoo", # old species name incorrectly matched to new nominate subspecies. NB. does not deal with data coming from ALA, as we're taking the already converted ALA scientific/species name.
  "Coturnix ypsilophora", "Synoicus ypsilophora", "Synoicus ypsilophora", NA, "Brown Quail", # old species name incorrectly matched to new nominate subspecies found only in Tasmania, but results in records all over the country. NB. does not deal with data coming from ALA, as we're taking the already converted ALA scientific/species name.
  "Cinclosoma castanotus", "Cinclosoma castanotum", "Cinclosoma castanotum", NA, "Chestnut Quail-thrush", # old species name incorrectly matched to new nominate subspecies. NB. does not deal with data coming from ALA, as we're taking the already converted ALA scientific/species name.
  "Macropus robustus", "Osphranter robustus", "Osphranter robustus", NA, "Euro" # old species name incorrectly matched to new nominate subspecies. NB. does not deal with data coming from ALA, as we're taking the already converted ALA scientific/species name.
  )
