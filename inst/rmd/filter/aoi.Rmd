...
* `r round(100*sum(!is.na(filt_report_data$lifespan))/nrow(filt_report_data),1)`% had some form of lifespan recorded
* `r round(100*sum(!is.na(filt_report_data$lifeform))/nrow(filt_report_data),1)`% had some form of lifeform recorded
